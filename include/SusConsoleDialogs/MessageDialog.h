...
public:
    ...
    static void run(const std::string& message, bool clearConsoleAtStart) {
    ...
    static std::unique_ptr<MessageDialog> create(const std::string& message, bool clearConsoleAtStart) {
